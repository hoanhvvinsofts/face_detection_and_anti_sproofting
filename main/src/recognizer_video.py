...
ap.add_argument("--video-in", default="E:/Timekeeping\Face Recognition with InsightFace/datasets/videos_input/TyrionLannister.mp4")
    ...
    if frames%3 == 0:
        ...
        if len(bboxes) != 0:
            ...
            for bboxe in bboxes:
                ...
                print(">> CosineSimilarity", cos_similarity)
